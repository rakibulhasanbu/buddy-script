...
export const AlertDialogContents = (props: AlertDialogProps) => {
  ...
  return (
    <AlertDialogContent className="max-w-md min-w-[380px]">
      <AlertDialogHeader>
        {props.showIcon && (
        ...
        {error && <AlertDialogDescription className="mt-2 text-destructive-foreground">{error}</AlertDialogDescription>}
      </AlertDialogHeader>
      <AlertDialogFooter className="mt-0 grid grid-cols-2 gap-4">
