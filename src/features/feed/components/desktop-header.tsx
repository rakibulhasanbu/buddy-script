...
const NotificationDropdown = () => {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-8 -left-27.5 z-50 h-[calc(100vh-90px)] w-100 overflow-auto rounded-md bg-white p-4 shadow-[0_8px_24px_rgba(149,157,165,0.2)]">
    ...
    <div ref={ref} className="relative flex items-center">
      ...
      <div className="flex cursor-pointer items-center">
        ...
        <button
          type="button"
          onClick={() => setOpen((prev) => !prev)}
          className="-mt-0.75 ml-2 border-transparent bg-transparent"
        >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <Link href="/" className="navbar-brand">
              <Image src="/images/logo.svg" alt="Buddy Script" width={169} height={40} className="h-auto w-42.25" />
            </Link>
          </div>
