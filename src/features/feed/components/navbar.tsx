    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button type="button" className="flex items-center outline-none">
          ...
          <svg className="ml-2" xmlns="http://www.w3.org/2000/svg" width="10" height="6" fill="none" viewBox="0 0 10 6">
            <path
              fill="#112032"
      ...
      <DropdownMenuContent align="end" className="w-70 p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden flex-1 items-center justify-end lg:flex">
            ...
            <ul className="mr-8 flex items-center">
              ...
              <li className="mx-3">
                <Link href="/friends/list" className={isActive("/friends") ? activeClass : inactiveClass}>
