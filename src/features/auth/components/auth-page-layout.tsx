...
export const AuthPageLayout = ({ children, illustration }: AuthPageLayoutProps) => {
  return (
    <section className="relative z-[1] min-h-screen w-full overflow-hidden bg-[#F0F2F5] py-[100px]">
      ...
      <div className="pointer-events-none absolute right-[327px] bottom-0 z-[-1] hidden xl:block">
